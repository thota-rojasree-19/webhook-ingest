...
// IngestEventTx atomically stores the event, upserts the call, and updates account stats
// within a single transaction. If the event_id already exists, it returns inserted=false with no error.
